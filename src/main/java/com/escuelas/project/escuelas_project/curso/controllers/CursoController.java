...
public class CursoController {
    ...
    @ResponseBody
    public ResponseEntity<List<CursoResponseDto>> findAllActive(@PathVariable Integer year, @PathVariable UUID id)
    ...
    @ResponseBody
    public ResponseEntity<CursoResponseDto> findById(@PathVariable UUID id) throws EntityDisabledException, CursoNoExistenteException {
    ...
    @ResponseBody
    public ResponseEntity<CursoResponseDto> save(@PathVariable UUID id, @RequestBody @Valid CursoDto dto)
    ...
    @ResponseBody
    @Transactional
    public ResponseEntity<CursoResponseDto> update(@RequestBody CursoDtoUpdate dto, @PathVariable UUID id)
